Shader "Custom/MultiplyShadowProceduralInverted"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float edgeMask = 1.0 - mask; // 0 center → 1 edges
                float m = lerp(1.0, 1.0 - _Darkness, edgeMask);
                return float4(m * _Color.rgb, 0);
            }
            ENDCG
        }
    }
